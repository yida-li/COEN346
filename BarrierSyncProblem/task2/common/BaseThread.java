...
public class BaseThread extends Thread {
	...
	/**
	 * Allows setting initial turn value to something else other than the default
	 * "1" (one).
	 * 
	...
	/**
	 * Just a make up for the PHASE I to make it somewhat tangeable. Must be atomic
	 * as it touches siTurn and siNextTID.
	 */
	...
	/**
	 * Just a make up for the PHASE II to make it somewhat tangeable. Must be atomic
	 * as it touches siTurn and siNextTID.
	 */
